...
#aktualizacja zawartosci widgetow
  def update_widgets(self):
    if config.get_str("EDMC_HKL_tag_fact_color") != "None" :
      self.treeview.tag_configure('faction', background='palegreen' if config.get_str("EDMC_HKL_tag_fact_color") == "" else config.get_str("EDMC_HKL_tag_fact_color"))
    if config.get_str("EDMC_HKL_tag_high_color") != "None" :
      self.treeview.tag_configure('high', background='pink' if config.get_str("EDMC_HKL_tag_high_color") == "" else config.get_str("EDMC_HKL_tag_high_color"))
    if config.get_str("EDMC_HKL_tag_low_color") != "None" :
      self.treeview.tag_configure('low', background='coral' if config.get_str("EDMC_HKL_tag_low_color") == "" else config.get_str("EDMC_HKL_tag_low_color"))
